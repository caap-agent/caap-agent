...
from src.supports.caap_prompter_support import logger
...
def view_at_annotator(self):
    ...
    # view_only Action
    listbox = self.win.children['listbox_frame'].children['!listbox']
...
'''
        ...
        elif action_name == "key_press" and action['key_combination'] == "Page_Up":
            script = f"action_{sel + 1}: {{name: press_pageup_button, arg: {{}}}}"

        elif action_name == "key_press" and action['key_combination'] == "Page_Down":
            script = f"action_{sel + 1}: {{name: press_pagedown_button, arg: {{}}}}"

        elif action_name == "key_press" and action['key_combination'] == "Home":
            script = f"action_{sel + 1}: {{name: press_home_button, arg: {{}}}}"
